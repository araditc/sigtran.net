...
| TCAP | Phase 4 foundation started with ASN.1 BER TLV primitives, package tags, transaction identifiers, and BER Invoke components; legacy simplified component flow still being replaced |
