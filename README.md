...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal, gated NuGet prerelease publication, and retained release notes artifacts are available; final commercial readiness report, migration notes, and RC/stable decisioning are still being implemented |
