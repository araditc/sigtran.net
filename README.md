...
| Supply-chain release execution | Phase 34 in progress: final versioned SBOM, trusted timestamped package signing, provenance attestation, public API diff, and artifact upload contracts are available; workflow wiring and final promotion gating are still being implemented |
