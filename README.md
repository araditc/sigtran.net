...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal and gated NuGet prerelease publication are available; final commercial readiness report, release notes, migration notes, and RC/stable decisioning are still being implemented |
