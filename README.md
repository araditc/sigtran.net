...
| Commercial evidence readiness lockdown | Phase 36 in progress: release target locking is available; secrets, artifact retention, evidence checklist, preflight, protected environment, dossier handoff, and go/no-go gating are still being implemented |
