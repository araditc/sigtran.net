...
| Commercial roadmap realignment | Phase 26 started: package-specific source API names are being replaced with package-neutral external SIGTRAN peer contracts; maintained peer selection and external peer lab environment contracts now require Linux native SCTP, packet capture, SDK traces, peer config/logs, retained artifacts, and license isolation |
