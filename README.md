...
| Supply-chain release execution | Phase 34 in progress: final versioned SBOM and trusted timestamped package signing evidence contracts are available; provenance attestation, public API diff artifact, workflow upload, and final promotion gating are still being implemented |
