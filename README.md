...
| TCAP | Phase 4 foundation started with ASN.1 BER TLV primitives, package tags, transaction identifiers, BER Invoke/ReturnResult/ReturnError/Reject components, and transaction message envelopes |
