...
| SCTP | Packet transport contract, connection options, stream selection, SIGTRAN PPID helpers, optional stream/PPID metadata, association lifecycle models, and development TCP adapter |
