...
| SCTP | Packet transport contract, connection options, reconnect policy, stream selection, SIGTRAN PPID helpers, optional stream/PPID metadata, association lifecycle models, and development TCP adapter |
