...
| SCCP | Phase 3 foundation started with connectionless message types, protocol class primitives, party address indicators, SSN, point code, and TBCD global title support; legacy simplified UDT still being replaced |
