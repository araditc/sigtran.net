...
| Commercial roadmap realignment | Phase 26 started: package-specific source API names are being replaced with package-neutral external SIGTRAN peer contracts; external peer commercial readiness now aggregates maintained peer selection, lab environment, run plan, and review-ready evidence |
