...
| SCTP | Packet transport contract, connection options, SIGTRAN PPID helpers, optional stream/PPID metadata, association lifecycle models, and development TCP adapter |
