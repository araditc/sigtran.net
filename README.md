...
| Release workflow orchestration | Phase 22/23 in progress: release workflow triggers, stages, required secrets, supply-chain integration, commercial evidence verification, publish contract, concrete workflow file, YAML validation, publish guard, artifact retention, readiness report, and status report added; workflow orchestration foundation is ready while promotion still requires release gates |
