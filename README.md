...
| TCAP | Phase 4 foundation started with ASN.1 BER TLV primitives, package tags, and transaction identifier models; legacy simplified component flow still being replaced |
