...
| Package publication readiness | Phase 24 in progress: release version policy and NuGet metadata contract added; package publication remains blocked until all publication contracts, credentials, evidence, signing, SBOM, and provenance gates are complete |
