...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal, gated NuGet prerelease publication, retained release notes, retained migration notes, final commercial readiness reporting, RC/stable decisioning, RC publication evidence manifest, and release workflow channel wiring are available; final status reporting is still being implemented |
