...
| MAP | Phase 5 foundation started with SMS operation metadata, BER context-specific parameter containers, TBCD address primitives, MO/MT-ForwardSM codecs, SendRoutingInfoForSM, ReportSM-DeliveryStatus, and AlertServiceCentre codecs |
