...
| Commercial evidence readiness lockdown | Phase 36 in progress: release target locking, protected secret readiness, evidence retention mapping, commercial evidence checklist, and release preflight are available; protected environment, dossier handoff, and go/no-go gating are still being implemented |
