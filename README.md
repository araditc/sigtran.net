...
| Native SCTP production hardening | Phase 31 in progress: outbound stream and PPID framing contract is available; production readiness still requires reconnect, backpressure, cancellation, multi-homing, lifecycle, fault recovery, and retained Linux SCTP evidence |
...
Phase 31 hardens native SCTP production contracts, starting with outbound stream and PPID framing before reconnect, backpressure, cancellation, multi-homing readiness, lifecycle, and fault recovery hardening.
