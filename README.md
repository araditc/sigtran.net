...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal, gated NuGet prerelease publication, retained release notes, and retained migration notes artifacts are available; final commercial readiness report and RC/stable decisioning are still being implemented |
