...
| Commercial roadmap realignment | Phase 26 started: package-specific source API names are being replaced with package-neutral external SIGTRAN peer contracts; external peer artifacts now distinguish complete evidence from digest-covered commercial-review-ready evidence |
