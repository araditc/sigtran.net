...
| Supply-chain release execution | Phase 34 in progress: final versioned SBOM, trusted timestamped package signing, and provenance attestation contracts are available; public API diff artifact, workflow upload, and final promotion gating are still being implemented |
