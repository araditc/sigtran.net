...
| Commercial roadmap realignment | Phase 26 started: package-specific source API names are being replaced with package-neutral external SIGTRAN peer contracts; peer profiles now identify maintained commercial candidates without naming public APIs after a peer package |
