...
| Release workflow orchestration | Phase 22/23 in progress: release workflow triggers, stages, required secrets, supply-chain integration, commercial evidence verification, publish contract, concrete workflow file, readiness report, and status report added; full orchestration still requires workflow validation and promotion hardening |
