...
| MAP | Phase 5 foundation started with SMS operation metadata, BER context-specific parameter containers, TBCD address primitives, and MO/MT-ForwardSM parameter codecs |
