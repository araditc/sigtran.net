...
| Commercial roadmap realignment | Phase 26 started: package-specific source API names are being replaced with package-neutral external SIGTRAN peer contracts; external peer run plans now use env-driven package-neutral lab commands for peer selection, capture, SDK traces, and comparison |
