...
| Commercial roadmap realignment | Phase 26 started: package-specific source API names are being replaced with package-neutral external SIGTRAN peer contracts; maintained peer selection now requires modern Linux, native SCTP, M3UA ASP-to-SG coverage, retained artifacts, and license isolation |
