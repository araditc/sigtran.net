...
| Interoperability lab | Phase 9 foundation-ready: lab scenario catalog, artifact manifests, run reports, OpenSS7/IPSS7 M3UA ASP-to-SG template, trace comparison, evidence promotion, opt-in CI profile, and readiness report added; production readiness still requires passing external lab evidence |
