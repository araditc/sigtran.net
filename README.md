...
| Release automation | Phase 10 started: deterministic release plan, artifact manifest with digest tracking, SBOM plan, package signing plan, provenance tracking, and release notes validation added |
