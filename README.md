...
| SCCP/TCAP/MAP evidence upgrade | Phase 32 in progress: shared protocol evidence vectors, byte-level mismatch validation, SCCP/TCAP/MAP SMS evidence vectors, and a cross-layer evidence bundle are available; trace validation, mismatch correction, and evidence-backed readiness gates are next |
...
Phase 32 upgrades SCCP, TCAP, and MAP SMS toward evidence-backed behavior, with shared byte-level evidence vector validation, SCCP/TCAP/MAP SMS evidence vectors, and a cross-layer evidence bundle in place before trace validation, mismatch correction, and evidence-backed readiness gates.
