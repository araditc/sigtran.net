...
| Commercial release execution | Phase 25 in progress: retained execution evidence manifest, Linux SCTP smoke capture evidence, structured OpenSS7/IPSS7 blocker evidence, artifact dossier, and executable SBOM generation evidence added; OpenSS7/IPSS7 remains blocked on WSL2 kernel compatibility |
