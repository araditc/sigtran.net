...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal, gated NuGet prerelease publication, retained release notes, retained migration notes, final commercial readiness reporting, RC/stable decisioning, and RC publication evidence manifest are available; workflow wiring is still being implemented |
