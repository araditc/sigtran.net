...
| Native SCTP production hardening | Phase 31 in progress: outbound stream/PPID framing and association lifecycle journal contracts are available; production readiness still requires reconnect, backpressure, cancellation, multi-homing, fault recovery, and retained Linux SCTP evidence |
...
Phase 31 hardens native SCTP production contracts, starting with outbound stream and PPID framing plus association lifecycle journaling before reconnect, backpressure, cancellation, multi-homing readiness, and fault recovery hardening.
