...
| Performance and resilience evidence | Phase 33 in progress: peer-traffic benchmark workload evidence models warmup, sustained, and peak stages; retained artifact manifests require digest-covered benchmark files; latency evidence evaluates P95/P99 against SDK budgets before commercial performance evidence can pass |
...
Phase 33 upgrades performance and resilience evidence, starting with a peer-traffic benchmark workload contract, retained artifact run plan, and latency P95/P99 evidence evaluator before resource, failover, and publishable report evidence are accepted.
