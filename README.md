...
| Native SCTP production hardening | Phase 31 in progress: outbound stream/PPID framing, association lifecycle journal, and reconnect schedule contracts are available; production readiness still requires backpressure, cancellation, multi-homing, fault recovery, and retained Linux SCTP evidence |
...
Phase 31 hardens native SCTP production contracts, starting with outbound stream and PPID framing, association lifecycle journaling, and reconnect scheduling before backpressure, cancellation, multi-homing readiness, and fault recovery hardening.
