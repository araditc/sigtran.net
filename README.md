...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal is available; gated prerelease publish, final commercial readiness report, release notes, migration notes, and RC/stable decisioning are still being implemented |
