...
| RC publish and commercial gate | Phase 35 in progress: dry-run release rehearsal, gated NuGet prerelease publication, retained release notes, retained migration notes, and final commercial readiness reporting are available; RC/stable decisioning and workflow wiring are still being implemented |
