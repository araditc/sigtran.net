...
| M3UA DATA routing | Mutable Payload route table with selector matching, replacement, snapshots, and name lookup |
...
| M3UA transport session | Async receive/send/wait facade with Heartbeat acknowledgement and resettable counters |
| M3UA ASP client | ASP startup, heartbeat, and shutdown helpers using transport wait APIs |
...
| M3UA diagnostics | Header summaries, typed message summaries, and offset-based hex dump formatting |
