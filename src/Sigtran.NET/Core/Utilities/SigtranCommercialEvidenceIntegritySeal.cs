...
/// <summary>
/// Describes an integrity seal over a retained commercial evidence ledger.
/// </summary>
public sealed class SigtranCommercialEvidenceIntegritySeal
{
    /// <summary>Creates an integrity seal over a retained commercial evidence ledger.</summary>
    /// <param name="ledger">The retained commercial evidence ledger.</param>
    ...
    public SigtranCommercialEvidenceIntegritySeal(
    ...
    /// <summary>The retained commercial evidence ledger.</summary>
    ...
    public string ComputedAggregateSha256 => SigtranCommercialEvidenceIntegritySeals.ComputeAggregateSha256(Ledger);
    ...
    {
        return $"commercialEvidenceIntegritySealReady={IsReady} sealId={SealId} entries={Ledger.Entries.Count}";
    }
}

/// <summary>
/// Provides retained commercial evidence integrity seal helpers.
/// </summary>
public static class SigtranCommercialEvidenceIntegritySeals
{
    /// <summary>Creates a default integrity seal over a ready retention ledger.</summary>
    /// <param name="ledger">The retained commercial evidence ledger.</param>
    /// <param name="sealedAtUtc">The UTC time when the seal was created.</param>
    /// <returns>The retained commercial evidence integrity seal.</returns>
    public static SigtranCommercialEvidenceIntegritySeal CreateDefault(
        SigtranCommercialEvidenceRetentionLedger ledger,
        DateTimeOffset sealedAtUtc)
    {
    ...
    public static string ComputeAggregateSha256(SigtranCommercialEvidenceRetentionLedger ledger)
    {
        ArgumentNullException.ThrowIfNull(ledger);
        ...
        foreach (SigtranCommercialEvidenceRetentionLedgerEntry entry in ledger.Entries
