...
public sealed class SigtranReleaseEvidenceRedactionReview
{
    ...
    public SigtranReleaseEvidenceRedactionReview(
        string retainedPath,
    ...
    public bool Required => SigtranReleaseEvidenceExecutionVerificationItem.IsTraceBearingKind(Kind);
...
public sealed class SigtranReleaseEvidenceRedactionReviewManifest
{
    ...
    public SigtranReleaseEvidenceRedactionReviewManifest(
        SigtranReleaseEvidenceArtifactDigestManifest digestManifest,
        IReadOnlyList<SigtranReleaseEvidenceRedactionReview> reviews)
    {
    ...
    public SigtranReleaseEvidenceArtifactDigestManifest DigestManifest { get; }

    /// <summary>The redaction reviews.</summary>
    public IReadOnlyList<SigtranReleaseEvidenceRedactionReview> Reviews { get; }
    ...
    public bool CoversTraceBearingArtifacts => DigestManifest.Digests
        .Where(static digest => SigtranReleaseEvidenceExecutionVerificationItem.IsTraceBearingKind(digest.Kind))
    ...
    {
        return $"productionEvidenceRedactionReady={IsReady} reviews={Reviews.Count} intake={DigestManifest.SourceManifest.Target.IntakeId}";
    }
}
...
public static class SigtranReleaseEvidenceRedactionReviews
{
    ...
    public static SigtranReleaseEvidenceRedactionReviewManifest CreateApproved(
        SigtranReleaseEvidenceArtifactDigestManifest digestManifest,
        string reviewerName,
        DateTimeOffset reviewedAtUtc)
    {
        ...
        return new(
            ...
            digestManifest.Digests
                .Where(static digest => SigtranReleaseEvidenceExecutionVerificationItem.IsTraceBearingKind(digest.Kind))
                .Select(digest => new SigtranReleaseEvidenceRedactionReview(
                    digest.RetainedPath,
                    digest.Kind,
                    reviewerName,
                    reviewedAtUtc,
