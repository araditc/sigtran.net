...
public sealed class SigtranReleaseEvidenceFileSystemPromotionExecution
{
    ...
    public SigtranReleaseEvidenceFileSystemPromotionExecution(
        SigtranReleaseEvidenceFileSystemPublicationAttachmentExecution attachmentExecution,
        SigtranReleaseEvidenceVerifiedPromotionGateResult promotionGate)
    {
    ...
    public SigtranReleaseEvidenceFileSystemPublicationAttachmentExecution AttachmentExecution { get; }

    /// <summary>The verified promotion gate result.</summary>
    public SigtranReleaseEvidenceVerifiedPromotionGateResult PromotionGate { get; }
    ...
    {
        return $"productionEvidenceFileSystemPromotionReady={IsReady} blockers={PromotionGate.Blockers.Count} reviewer={PromotionGate.ReleaseReviewer}";
    }
}
...
public static class SigtranReleaseEvidenceFileSystemPromotions
{
    ...
    public static SigtranReleaseEvidenceFileSystemPromotionExecution Evaluate(
        SigtranReleaseEvidenceFileSystemPublicationAttachmentExecution attachmentExecution,
        ...
        bool evidenceApproved = true)
    {
        ...
        SigtranReleaseEvidenceVerifiedPromotionGateResult gate = SigtranReleaseEvidenceVerifiedPromotionGates.Evaluate(
