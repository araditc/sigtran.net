...
/// <summary>
/// Describes one retained commercial evidence ledger entry.
/// </summary>
public sealed class SigtranCommercialEvidenceRetentionLedgerEntry
{
    /// <summary>Creates a retained commercial evidence ledger entry.</summary>
    ...
    public SigtranCommercialEvidenceRetentionLedgerEntry(
...
/// <summary>
/// Describes the retained commercial evidence retention ledger.
/// </summary>
public sealed class SigtranCommercialEvidenceRetentionLedger
{
    /// <summary>Creates a retained commercial evidence retention ledger.</summary>
    ...
    public SigtranCommercialEvidenceRetentionLedger(
        SigtranCommercialEvidenceFileVerificationReport report,
        IReadOnlyList<SigtranCommercialEvidenceRetentionLedgerEntry> entries,
    ...
    public IReadOnlyList<SigtranCommercialEvidenceRetentionLedgerEntry> Entries { get; }
    ...
    {
        return $"commercialEvidenceRetentionLedgerReady={IsReady} entries={Entries.Count} minimumRetentionDays={MinimumRetentionDays}";
    }
}

/// <summary>
/// Provides retained commercial evidence retention ledger helpers.
/// </summary>
public static class SigtranCommercialEvidenceRetentionLedgers
{
    ...
    /// <returns>The retained commercial evidence retention ledger.</returns>
    public static SigtranCommercialEvidenceRetentionLedger CreateDefault(
        SigtranCommercialEvidenceFileVerificationReport report,
        string reviewer,
        DateTimeOffset retainedAtUtc,
        int retentionDays = 365)
    {
        ...
        return new(
            ...
            report.Manifest.Files
                .Select(file => new SigtranCommercialEvidenceRetentionLedgerEntry(
                    file.Kind,
                    file.RetainedPath,
                    file.ActualSha256,
                    retainedAt,
