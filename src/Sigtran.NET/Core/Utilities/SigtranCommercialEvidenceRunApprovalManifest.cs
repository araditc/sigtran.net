...
/// <summary>
/// Describes one reviewer approval for a commercial evidence run.
/// </summary>
public sealed class SigtranCommercialEvidenceReviewerApproval
{
    /// <summary>Creates a commercial evidence reviewer approval.</summary>
    ...
    public SigtranCommercialEvidenceReviewerApproval(
        string reviewerName,
        string role,
        bool approved,
...
/// <summary>
/// Describes reviewer approvals for a commercial evidence run.
/// </summary>
public sealed class SigtranCommercialEvidenceRunApprovalManifest
{
    ...
    /// <summary>Creates a commercial evidence run approval manifest.</summary>
    ...
    public SigtranCommercialEvidenceRunApprovalManifest(
        SigtranCommercialEvidenceRunApprovalChecklist checklist,
        string checklistSha256,
        IReadOnlyList<SigtranCommercialEvidenceReviewerApproval> approvals)
    {
    ...
    public SigtranCommercialEvidenceRunApprovalChecklist Checklist { get; }
    ...
    public IReadOnlyList<SigtranCommercialEvidenceReviewerApproval> Approvals { get; }
    ...
    public bool ChecklistDigestMatches => string.Equals(ChecklistSha256, SigtranCommercialEvidenceRunApprovalManifests.ComputeChecklistSha256(Checklist), StringComparison.OrdinalIgnoreCase);
    ...
    /// <summary>Whether the approval manifest can be retained as an approved commercial run record.</summary>
    ...
    {
        return $"commercialEvidenceRunApprovalManifestReady={IsReady} approvals={Approvals.Count} runId={Checklist.Target.RunId}";
    }
}

/// <summary>
/// Provides commercial evidence run approval manifest helpers.
/// </summary>
public static class SigtranCommercialEvidenceRunApprovalManifests
{
    ...
    /// <returns>The commercial evidence run approval manifest.</returns>
    public static SigtranCommercialEvidenceRunApprovalManifest CreateDefault(
        SigtranCommercialEvidenceRunApprovalChecklist checklist,
        DateTimeOffset approvedAtUtc,
    ...
    public static string ComputeChecklistSha256(SigtranCommercialEvidenceRunApprovalChecklist checklist)
    {
        ArgumentNullException.ThrowIfNull(checklist);
        ...
        foreach (SigtranCommercialEvidenceRunApprovalChecklistItem item in checklist.Items.OrderBy(static item => item.Id, StringComparer.OrdinalIgnoreCase))
        {
