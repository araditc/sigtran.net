...
public sealed class SigtranReleaseEvidenceApprovedRunTarget
{
    ...
    public SigtranReleaseEvidenceApprovedRunTarget(
        string runId,
        ...
        SigtranReleaseEvidenceFileSystemPromotionExecution promotionExecution)
    {
    ...
    /// <summary>The stable release evidence run identifier.</summary>
    ...
    public SigtranReleaseEvidenceFileSystemPromotionExecution PromotionExecution { get; }
    ...
    /// <summary>Whether the production evidence run can enter approval review.</summary>
    ...
    /// <summary>Formats a compact production evidence run approval target summary.</summary>
    /// <returns>The production evidence run approval target summary.</returns>
    public string Describe()
    {
        return $"productionEvidenceRunReadyForApproval={IsReadyForApproval} runId={RunId} version={PackageVersion}";
    }
}
...
public static class SigtranReleaseEvidenceApprovedRunTargets
{
    ...
    /// <param name="completedAtUtc">The UTC run completion time.</param>
    /// <param name="promotionExecution">The filesystem-backed promotion execution result.</param>
    /// <returns>The production evidence run approval target.</returns>
    public static SigtranReleaseEvidenceApprovedRunTarget Create(
        string runId,
        string packageVersion,
        string sourceCommit,
        string artifactRoot,
