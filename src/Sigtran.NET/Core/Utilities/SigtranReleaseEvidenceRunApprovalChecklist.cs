...
public sealed class SigtranReleaseEvidenceRunApprovalChecklistItem
{
    ...
    public SigtranReleaseEvidenceRunApprovalChecklistItem(
        string id,
        string description,
        bool required,
        bool satisfied)
...
public sealed class SigtranReleaseEvidenceRunApprovalChecklist
{
    ...
    public SigtranReleaseEvidenceRunApprovalChecklist(
        SigtranReleaseEvidenceApprovedRunTarget target,
        IReadOnlyList<SigtranReleaseEvidenceRunApprovalChecklistItem> items)
    {
    ...
    /// <summary>The production evidence run approval target.</summary>
    public SigtranReleaseEvidenceApprovedRunTarget Target { get; }

    /// <summary>The checklist items.</summary>
    public IReadOnlyList<SigtranReleaseEvidenceRunApprovalChecklistItem> Items { get; }
    ...
    {
        return $"productionEvidenceRunApprovalChecklistReady={IsReady} items={Items.Count} unsatisfied={GetUnsatisfiedRequiredItemIds().Count}";
    }
}
...
public static class SigtranReleaseEvidenceRunApprovalChecklists
{
    ...
    /// <returns>The production evidence run approval checklist.</returns>
    public static SigtranReleaseEvidenceRunApprovalChecklist CreateDefault(
        SigtranReleaseEvidenceApprovedRunTarget target,
