...
/// <summary>
/// Describes maintained external peer lab runner workflow readiness.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerWorkflowReadinessReport
{
    /// <summary>Creates a maintained peer lab runner workflow readiness report.</summary>
    /// <param name="workflowTemplate">The workflow template.</param>
    /// <param name="commandManifest">The runner command manifest.</param>
    public SigtranMaintainedPeerLabRunnerWorkflowReadinessReport(
    ...
    /// <summary>Whether workflow policy is safe for maintained peer lab execution.</summary>
    ...
    /// <summary>Whether the runner workflow is ready to execute on a maintained peer lab runner.</summary>
...
/// <summary>
/// Provides maintained external peer lab runner workflow readiness helpers.
/// </summary>
public static class SigtranMaintainedPeerLabRunnerWorkflowReadiness
{
    ...
    public static SigtranMaintainedPeerLabRunnerWorkflowReadinessReport Evaluate(SigtranMaintainedPeerLabRunnerCommandManifest commandManifest)
    {
        ArgumentNullException.ThrowIfNull(commandManifest);
        return new(SigtranMaintainedPeerLabWorkflows.CreateDefault(), commandManifest);
    }
}
