...
/// <summary>
/// Identifies maintained external peer lab runner evidence package item kinds.
/// </summary>
public enum SigtranMaintainedPeerLabRunnerEvidencePackageItemKind
{
...
/// <summary>
/// Describes one maintained external peer lab runner evidence package item.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerEvidencePackageItem
{
    /// <summary>Creates a maintained peer lab runner evidence package item.</summary>
    ...
    public SigtranMaintainedPeerLabRunnerEvidencePackageItem(
        SigtranMaintainedPeerLabRunnerEvidencePackageItemKind kind,
        string name,
        string path,
        bool required,
        bool verified,
    ...
    public SigtranMaintainedPeerLabRunnerEvidencePackageItemKind Kind { get; }
...
/// <summary>
/// Describes a maintained external peer lab runner evidence package manifest.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerEvidencePackageManifest
{
    private readonly SigtranMaintainedPeerLabRunnerEvidencePackageItem[] _items;

    /// <summary>Creates a maintained peer lab runner evidence package manifest.</summary>
    ...
    public SigtranMaintainedPeerLabRunnerEvidencePackageManifest(
        ...
        IReadOnlyList<SigtranMaintainedPeerLabRunnerEvidencePackageItem> items)
    {
    ...
    public SigtranMaintainedPeerLabRunnerArtifactVerificationReport ArtifactVerification { get; }

    /// <summary>The provenance report.</summary>
    public SigtranMaintainedPeerLabRunnerProvenanceReport Provenance { get; }

    /// <summary>The comparison handoff.</summary>
    public SigtranMaintainedPeerLabRunnerComparisonHandoff ComparisonHandoff { get; }
    ...
    public IReadOnlyList<SigtranMaintainedPeerLabRunnerEvidencePackageItem> Items => _items.ToArray();
    ...
    public string RenderMarkdown()
    {
        ...
        builder.AppendLine("# Maintained Peer Lab Runner Evidence Package");
        builder.AppendLine();
        ...
        foreach (SigtranMaintainedPeerLabRunnerEvidencePackageItem item in _items)
        {
...
/// <summary>
/// Provides maintained external peer lab runner evidence package helpers.
/// </summary>
public static class SigtranMaintainedPeerLabRunnerEvidencePackages
{
    ...
    public static SigtranMaintainedPeerLabRunnerEvidencePackageManifest Create(
        SigtranMaintainedPeerLabRunnerArtifactVerificationReport artifactVerification,
        SigtranMaintainedPeerLabRunnerProvenanceReport provenance,
        SigtranMaintainedPeerLabRunnerComparisonHandoff comparisonHandoff,
        SigtranMaintainedPeerLabRunnerFailureReport failureReport)
    {
        ...
        List<SigtranMaintainedPeerLabRunnerEvidencePackageItem> items = [];
        foreach (SigtranMaintainedPeerLabRunnerArtifactVerificationItem item in artifactVerification.Items)
        {
            items.Add(new(
                SigtranMaintainedPeerLabRunnerEvidencePackageItemKind.RetainedArtifact,
