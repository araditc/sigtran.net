...
/// <summary>
/// Describes one maintained external peer lab runner output artifact.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerArtifactOutput
{
    /// <summary>Creates a maintained peer lab runner output artifact.</summary>
    ...
    public SigtranMaintainedPeerLabRunnerArtifactOutput(
        SigtranMaintainedPeerLabArtifactKind kind,
        string path,
        bool required,
        SigtranMaintainedPeerLabCommandKind producerCommandKind)
    {
        Kind = kind;
    ...
    public SigtranMaintainedPeerLabCommandKind ProducerCommandKind { get; }
...
/// <summary>
/// Describes the expected output materialization plan for a maintained external peer lab runner.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerArtifactMaterializationPlan
{
    private readonly SigtranMaintainedPeerLabRunnerArtifactOutput[] _outputs;

    /// <summary>Creates a maintained peer lab runner artifact materialization plan.</summary>
    /// <param name="workspace">The runner workspace.</param>
    /// <param name="outputs">The expected output artifacts.</param>
    public SigtranMaintainedPeerLabRunnerArtifactMaterializationPlan(
        SigtranMaintainedPeerLabRunnerWorkspace workspace,
        IReadOnlyList<SigtranMaintainedPeerLabRunnerArtifactOutput> outputs)
    {
    ...
    public IReadOnlyList<SigtranMaintainedPeerLabRunnerArtifactOutput> Outputs => _outputs.ToArray();
...
/// <summary>
/// Provides maintained external peer lab runner artifact materialization helpers.
/// </summary>
public static class SigtranMaintainedPeerLabRunnerArtifacts
{
    ...
    public static SigtranMaintainedPeerLabRunnerArtifactMaterializationPlan CreateDefault(SigtranMaintainedPeerLabRunnerWorkspace workspace)
    {
        ArgumentNullException.ThrowIfNull(workspace);
        ...
        return new(
            ...
            workspace.RunManifest.ArtifactPlan.Items
                .Select(item => new SigtranMaintainedPeerLabRunnerArtifactOutput(
                    item.Kind,
                    item.Path,
                    item.Required,
    ...
    private static SigtranMaintainedPeerLabCommandKind FindProducer(
        SigtranMaintainedPeerLabCommandPlan commandPlan,
        SigtranMaintainedPeerLabArtifactKind artifactKind)
    {
