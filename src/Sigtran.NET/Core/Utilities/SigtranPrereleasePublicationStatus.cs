...
public static class SigtranPrereleasePublicationStatus
{
    ...
    [
        ...
        "stable-release-evidence-required-for-stable"
    ];

    /// <summary>The status label.</summary>
    public const string StatusLabel = "Release Candidate Publication Gate";

    /// <summary>The number of completed prerelease publication gate work units.</summary>
    public const int CompletedUnitCount = 10;

    /// <summary>Returns the completed prerelease publication capability names.</summary>
    ...
    /// <summary>Whether stable release publication is ready.</summary>
    public static bool StableReleasePublicationReady => false;

    /// <summary>Formats a compact prerelease publication status summary.</summary>
    /// <returns>The prerelease publication status summary.</returns>
    public static string Describe()
    {
        return $"{StatusLabel}: completedUnits={CompletedUnitCount} capabilities={Capabilities.Length} gateFoundationReady={GateFoundationReady} realPublicationReady={RealPublicationReady} stableReleasePublicationReady={StableReleasePublicationReady} blockers={DefaultBlockers.Length}";
    }
