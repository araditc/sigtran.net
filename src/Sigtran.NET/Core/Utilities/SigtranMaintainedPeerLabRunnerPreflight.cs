...
/// <summary>
/// Describes one maintained external peer lab runner preflight check.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerPreflightCheck
{
    /// <summary>Creates a maintained peer lab runner preflight check.</summary>
    ...
    public SigtranMaintainedPeerLabRunnerPreflightCheck(
        string id,
        string description,
        bool passed,
        bool required = true)
...
/// <summary>
/// Describes maintained external peer lab runner preflight output.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerPreflightReport
{
    private readonly SigtranMaintainedPeerLabRunnerPreflightCheck[] _checks;

    /// <summary>Creates a maintained peer lab runner preflight report.</summary>
    /// <param name="runId">The lab run id.</param>
    /// <param name="checks">The preflight checks.</param>
    public SigtranMaintainedPeerLabRunnerPreflightReport(
        string runId,
        IReadOnlyList<SigtranMaintainedPeerLabRunnerPreflightCheck> checks)
    {
    ...
    public IReadOnlyList<SigtranMaintainedPeerLabRunnerPreflightCheck> Checks => _checks.ToArray();
...
/// <summary>
/// Provides maintained external peer lab runner preflight helpers.
/// </summary>
public static class SigtranMaintainedPeerLabRunnerPreflight
{
    ...
    public static SigtranMaintainedPeerLabRunnerPreflightReport Evaluate(
        ...
        IReadOnlyList<string> satisfiedPrerequisiteIds)
    {
        ...
        SigtranMaintainedPeerLabPrerequisiteReport prerequisiteReport = SigtranMaintainedPeerLabPrerequisites.Evaluate(satisfiedPrerequisiteIds);
        SigtranMaintainedPeerLabConfigurationValidation configuration = inputBundle.Workspace.RunManifest.Configuration.Validate();
        ...
        return new(
            ...
            [
                ...
                new("configuration-valid", "Maintained peer lab configuration is valid.", configuration.IsValid),
