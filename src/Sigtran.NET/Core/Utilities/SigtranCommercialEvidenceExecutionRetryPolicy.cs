...
/// <summary>
/// Describes one retry rule for a commercial evidence execution blocker kind.
/// </summary>
public sealed class SigtranCommercialEvidenceExecutionRetryRule
{
    /// <summary>Creates a commercial evidence execution retry rule.</summary>
    ...
    public SigtranCommercialEvidenceExecutionRetryRule(
        SigtranCommercialEvidenceExecutionBlockerKind blockerKind,
        bool retryable,
        int maximumAttempts,
    ...
    public SigtranCommercialEvidenceExecutionBlockerKind BlockerKind { get; }
...
/// </summary>
public sealed class SigtranCommercialEvidenceExecutionRetryDecision
{
    /// <summary>Creates a commercial evidence execution retry decision.</summary>
    ...
    public SigtranCommercialEvidenceExecutionRetryDecision(
        SigtranCommercialEvidenceExecutionBlocker blocker,
        bool canRetry,
    ...
    public SigtranCommercialEvidenceExecutionBlocker Blocker { get; }
...
/// <summary>
/// Describes the commercial evidence execution retry and resume policy.
/// </summary>
public sealed class SigtranCommercialEvidenceExecutionRetryPolicy
{
    /// <summary>Creates a commercial evidence execution retry policy.</summary>
    /// <param name="catalog">The execution stage catalog.</param>
    /// <param name="rules">The retry rules.</param>
    public SigtranCommercialEvidenceExecutionRetryPolicy(
        SigtranCommercialEvidenceExecutionStageCatalog catalog,
        IReadOnlyList<SigtranCommercialEvidenceExecutionRetryRule> rules)
    {
    ...
    public IReadOnlyList<SigtranCommercialEvidenceExecutionRetryRule> Rules { get; }

    /// <summary>Whether retry rules cover known blocker kinds.</summary>
    public bool CoversKnownBlockers => SigtranCommercialEvidenceExecutionBlockers.CreateDefault().KnownBlockers
    ...
    public bool ProtectsNonRetryableFailures => Rules
        .Where(static rule => rule.BlockerKind is SigtranCommercialEvidenceExecutionBlockerKind.NativeSctp
            or SigtranCommercialEvidenceExecutionBlockerKind.ProtectedApproval
            or SigtranCommercialEvidenceExecutionBlockerKind.Unknown)
    ...
    public SigtranCommercialEvidenceExecutionRetryDecision Decide(
        SigtranCommercialEvidenceExecutionBlocker blocker,
        int attemptCount)
    {
        ...
        SigtranCommercialEvidenceExecutionRetryRule rule = Rules.FirstOrDefault(item => item.BlockerKind == blocker.Kind)
            ?? Rules.First(item => item.BlockerKind == SigtranCommercialEvidenceExecutionBlockerKind.Unknown);
    ...
    {
        return $"commercialEvidenceRetryPolicyReady={IsReady} rules={Rules.Count}";
    }
}

/// <summary>
/// Provides commercial evidence execution retry policy helpers.
/// </summary>
public static class SigtranCommercialEvidenceExecutionRetryPolicies
{
    /// <summary>Creates the default retry and resume policy.</summary>
    /// <param name="catalog">The execution stage catalog.</param>
    /// <returns>The default retry and resume policy.</returns>
    public static SigtranCommercialEvidenceExecutionRetryPolicy CreateDefault(SigtranCommercialEvidenceExecutionStageCatalog catalog)
    {
        ...
        return new(
            catalog,
            [
                new(SigtranCommercialEvidenceExecutionBlockerKind.ReadinessPreflight, false, 1, "readiness-preflight"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.Environment, true, 3, "readiness-preflight"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.CommandFailure, true, 2, "readiness-preflight"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.NativeSctp, false, 1, "native-sctp-lab"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.ExternalPeer, true, 3, "external-peer-interop"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.ArtifactRetention, true, 2, "dossier-assembly"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.DigestVerification, true, 2, "dossier-assembly"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.RedactionReview, true, 2, "dossier-assembly"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.ProtectedApproval, false, 1, "dossier-assembly"),
                new(SigtranCommercialEvidenceExecutionBlockerKind.Unknown, false, 1, "readiness-preflight")
            ]);
    }
}
