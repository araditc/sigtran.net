...
public sealed class SigtranReleaseEvidenceFileSystemObservation
{
    ...
    public SigtranReleaseEvidenceFileSystemObservation(
        string fileSystemPath,
        SigtranReleaseEvidenceRetainedFile retainedFile)
    {
    ...
    public SigtranReleaseEvidenceRetainedFile RetainedFile { get; }
    ...
    {
        return $"productionEvidenceFileSystemObservation={FileSystemPath} verified={IsVerified} exists={Exists}";
    }
}
...
public static class SigtranReleaseEvidenceFileSystemObserver
{
    ...
    public static SigtranReleaseEvidenceFileSystemObservation Observe(
        ...
        DateTimeOffset? observedAtUtc = null)
    {
        ...
        SigtranReleaseEvidenceRetainedFile retainedFile = new(
            item.Kind,
            item.RetainedPath,
            item.Sha256,
            actualSha256,
