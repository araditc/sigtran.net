...
public sealed class SigtranReferencePeerLabWorkflowTemplate
{
    ...
    /// <param name="ciProfile">The reference peer lab CI profile.</param>
    public SigtranReferencePeerLabWorkflowTemplate(
        string name,
        string path,
    ...
    /// <summary>The reference peer lab CI profile.</summary>
    ...
    public string RenderYaml()
    {
        ...
        builder.AppendLine("        description: Reference peer lab run id");
        builder.AppendLine("        required: true");
        builder.AppendLine("        default: reference-peer-lab-run");
        builder.AppendLine();
        builder.AppendLine("permissions:");
        builder.AppendLine("  contents: read");
        builder.AppendLine();
        builder.AppendLine("jobs:");
        builder.AppendLine("  reference-peer-lab:");
...
public static class SigtranReferencePeerLabWorkflows
{
    ...
    public static SigtranReferencePeerLabWorkflowTemplate CreateDefault()
    {
        return new(
            "reference-peer-lab",
            ".github/workflows/reference-peer-lab.yml",
