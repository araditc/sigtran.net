...
/// <summary>
/// Describes provenance for a maintained external peer lab runner evidence package.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerProvenanceReport
{
    /// <summary>Creates maintained peer lab runner provenance.</summary>
    ...
    public SigtranMaintainedPeerLabRunnerProvenanceReport(
        string runId,
        string sdkName,
        string sdkVersion,
    ...
    public string RenderMarkdown()
    {
        ...
        builder.AppendLine("# Maintained Peer Lab Runner Provenance");
        builder.AppendLine();
...
/// <summary>
/// Provides maintained external peer lab runner provenance helpers.
/// </summary>
public static class SigtranMaintainedPeerLabRunnerProvenance
{
    /// <summary>Creates default maintained peer lab runner provenance.</summary>
    /// <param name="runManifest">The run manifest.</param>
    /// <param name="sourceCommit">The source commit SHA.</param>
    /// <param name="runnerHost">The runner host name or stable runner identity.</param>
    /// <param name="generatedUtc">The UTC provenance generation time.</param>
    /// <returns>The maintained peer lab runner provenance report.</returns>
    public static SigtranMaintainedPeerLabRunnerProvenanceReport CreateDefault(
