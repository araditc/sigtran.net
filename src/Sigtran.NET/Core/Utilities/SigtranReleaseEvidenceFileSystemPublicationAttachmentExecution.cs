...
public sealed class SigtranReleaseEvidenceFileSystemPublicationAttachmentExecution
{
    ...
    public SigtranReleaseEvidenceFileSystemPublicationAttachmentExecution(
        SigtranReleaseEvidenceFileSystemIntegritySealExecution sealExecution,
    ...
    public SigtranReleaseEvidenceFileSystemIntegritySealExecution SealExecution { get; }
    ...
    {
        return $"productionEvidenceFileSystemPublicationAttachmentsReady={IsReady} attachments={AttachmentManifest.Attachments.Count}";
    }
}
...
public static class SigtranReleaseEvidenceFileSystemPublicationAttachments
{
    ...
    public static SigtranReleaseEvidenceFileSystemPublicationAttachmentExecution Create(
        SigtranReleaseEvidenceFileSystemIntegritySealExecution sealExecution,
        bool publishable = true,
        bool redactionApproved = true)
    {
        ArgumentNullException.ThrowIfNull(sealExecution);
        SigtranReleaseEvidencePublicationAttachmentManifest manifest = SigtranReleaseEvidencePublicationAttachments.CreateDefault(
            sealExecution.Seal,
            publishable,
            redactionApproved);
