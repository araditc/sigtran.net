...
public sealed class SigtranReleaseEvidenceFileSystemArtifactWriteResult
{
    ...
    public SigtranReleaseEvidenceFileSystemArtifactWriteResult(
        SigtranReleaseEvidenceFileSystemVerificationExecution verificationExecution,
    ...
    public SigtranReleaseEvidenceFileSystemVerificationExecution VerificationExecution { get; }
    ...
    {
        return $"productionEvidenceFileSystemArtifactsReady={IsReady} report={ReportPath} observations={ObservationManifestPath}";
    }
}
...
public static class SigtranReleaseEvidenceFileSystemArtifactWriters
{
    ...
    public static SigtranReleaseEvidenceFileSystemArtifactWriteResult WriteVerificationArtifacts(
        SigtranReleaseEvidenceFileSystemVerificationExecution verificationExecution,
        string outputDirectory,
    ...
    private static string RenderReport(SigtranReleaseEvidenceFileSystemVerificationExecution execution)
    {
        return string.Join(
            Environment.NewLine,
            [
                "# Production Evidence Filesystem Verification Report",
                string.Empty,
    ...
    private static string RenderObservations(IReadOnlyList<SigtranReleaseEvidenceFileSystemObservation> observations)
    {
