...
public sealed class SigtranReleaseTargetLock
{
    ...
    public SigtranReleaseTargetLock(
        string version,
        string sourceCommit,
        string sourceBranch,
        string channel,
    ...
    public bool IsPrerelease => Version.Contains("-rc.", StringComparison.OrdinalIgnoreCase);
    ...
    /// <summary>Whether the channel is a supported production readiness channel.</summary>
    ...
    public bool IsLocked => IsPrerelease
        && HasPinnedCommit
        && HasSupportedChannel
...
public static class SigtranReleaseTargetLocks
{
    ...
    public static SigtranReleaseTargetLock CreatePrerelease(string version, string sourceCommit)
    {
        return new(
            version,
            sourceCommit,
            "main",
            "prerelease",
            $"artifacts/production-readiness/{version}");
    }
}
