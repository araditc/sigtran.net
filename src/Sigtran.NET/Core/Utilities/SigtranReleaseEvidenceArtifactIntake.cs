...
public sealed class SigtranReleaseEvidenceArtifactIntakeTarget
{
    ...
    public SigtranReleaseEvidenceArtifactIntakeTarget(
        string intakeId,
    ...
    public SigtranReleaseEvidenceExecutionRun ExecutionRun { get; }
    ...
    {
        return $"productionEvidenceArtifactIntake={IntakeId} run={ExecutionRun.RunId} ready={IsReady}";
    }
}
...
public static class SigtranReleaseEvidenceArtifactIntakes
{
    ...
    public static SigtranReleaseEvidenceArtifactIntakeTarget CreateDefault(
        SigtranReleaseEvidenceExecutionRun executionRun,
        string intakeId,
        string reviewerName,
        DateTimeOffset receivedAtUtc)
