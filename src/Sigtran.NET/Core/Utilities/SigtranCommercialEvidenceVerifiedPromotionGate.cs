...
/// <summary>
/// Describes the verified commercial evidence promotion gate result.
/// </summary>
public sealed class SigtranCommercialEvidenceVerifiedPromotionGateResult
{
    /// <summary>Creates a verified commercial evidence promotion gate result.</summary>
    /// <param name="attachmentManifest">The publication attachment manifest under review.</param>
    /// <param name="releaseReviewer">The reviewer that evaluated commercial evidence promotion.</param>
    /// <param name="evaluatedAtUtc">The UTC evaluation time.</param>
    /// <param name="evidenceApproved">Whether commercial evidence promotion was explicitly approved.</param>
    /// <param name="blockers">The promotion gate blockers.</param>
    public SigtranCommercialEvidenceVerifiedPromotionGateResult(
    ...
    /// <summary>The reviewer that evaluated commercial evidence promotion.</summary>
    public string ReleaseReviewer { get; }

    /// <summary>The UTC evaluation time.</summary>
    public DateTimeOffset EvaluatedAtUtc { get; }

    /// <summary>Whether commercial evidence promotion was explicitly approved.</summary>
    ...
    {
        return $"commercialEvidencePromotionReady={CanPromoteEvidence} blockers={Blockers.Count} reviewer={ReleaseReviewer}";
    }
}

/// <summary>
/// Provides verified commercial evidence promotion gate helpers.
/// </summary>
public static class SigtranCommercialEvidenceVerifiedPromotionGates
{
    /// <summary>Evaluates whether retained commercial evidence can be promoted.</summary>
    /// <param name="attachmentManifest">The publication attachment manifest under review.</param>
    /// <param name="releaseReviewer">The reviewer that evaluated commercial evidence promotion.</param>
    /// <param name="evaluatedAtUtc">The UTC evaluation time.</param>
    /// <param name="evidenceApproved">Whether commercial evidence promotion was explicitly approved.</param>
    /// <returns>The verified commercial evidence promotion gate result.</returns>
    public static SigtranCommercialEvidenceVerifiedPromotionGateResult Evaluate(
        SigtranCommercialEvidencePublicationAttachmentManifest attachmentManifest,
        string releaseReviewer,
        DateTimeOffset evaluatedAtUtc,
        bool evidenceApproved)
    {
        ...
        if (!attachmentManifest.IncludesCommercialReadinessReport)
        {
            blockers.Add("commercial-readiness-report-missing");
        }

        if (!evidenceApproved)
        {
            blockers.Add("commercial-evidence-approval-missing");
        }
