...
/// <summary>
/// Describes the filesystem workspace used by a maintained external peer lab runner.
/// </summary>
public sealed class SigtranMaintainedPeerLabRunnerWorkspace
{
    /// <summary>Creates a maintained peer lab runner workspace.</summary>
    ...
    public SigtranMaintainedPeerLabRunnerWorkspace(
    ...
    /// <summary>The maintained peer lab run manifest.</summary>
    ...
    /// <summary>Returns the directories that must exist before a maintained peer lab run starts.</summary>
...
/// <summary>
/// Provides maintained external peer lab runner workspace helpers.
/// </summary>
public static class SigtranMaintainedPeerLabRunnerWorkspaces
{
    /// <summary>Creates the default runner workspace from a maintained peer lab run manifest.</summary>
    /// <param name="runManifest">The maintained peer lab run manifest.</param>
    /// <returns>The default maintained peer lab runner workspace.</returns>
    public static SigtranMaintainedPeerLabRunnerWorkspace CreateDefault(SigtranMaintainedPeerLabRunManifest runManifest)
    {
        ArgumentNullException.ThrowIfNull(runManifest);
        ...
        string scriptRoot = $"{workspaceRoot}/scripts/maintained-peer-lab";
