    ...
    public static SigtranSupplyChainReleaseCommandPlan CreateDefault(string version)
    {
        ...
        return new(
            ...
            [
                ...
                new SigtranSupplyChainReleaseCommand(SigtranSupplyChainReleaseCommandKind.CreateProvenance, "Create provenance", $"gh attestation sign --predicate artifacts/supply-chain/sbom/Sigtran.NET.{normalizedVersion}.spdx.json --subject-path artifacts/release/Sigtran.NET.{normalizedVersion}.nupkg > artifacts/supply-chain/provenance/Sigtran.NET.{normalizedVersion}.intoto.jsonl", requiresSecret: false),
