...
public sealed class SigtranReferencePeerLabEnvironmentFile
{
    ...
    /// <summary>Creates a reference external peer lab environment file.</summary>
    /// <param name="variables">The environment variables.</param>
    public SigtranReferencePeerLabEnvironmentFile(IReadOnlyDictionary<string, string> variables)
    {
    ...
    public string Render()
    {
        ...
        builder.AppendLine("# SIGTRAN.NET reference peer lab environment");
...
public static class SigtranReferencePeerLabEnvironmentFiles
{
    ...
    /// <returns>The reference peer lab environment file.</returns>
    public static SigtranReferencePeerLabEnvironmentFile FromManifest(SigtranReferencePeerLabRunManifest manifest)
    {
        ...
        return new SigtranReferencePeerLabEnvironmentFile(variables);
    }
}
