...
public sealed class SigtranStableReleaseReportWriteResult
{
    ...
    public SigtranStableReleaseReportWriteResult(
    ...
    /// <summary>Whether the stable release release is complete.</summary>
    public bool StableReleaseComplete => PublishPlan.IsReady
        && StableTagCreated
    ...
    /// <summary>Returns stable release report blockers.</summary>
    /// <returns>The stable release report blockers.</returns>
    ...
    /// <summary>Formats a compact stable release report summary.</summary>
    /// <returns>The stable release report summary.</returns>
    public string Describe()
    {
        return $"stableReleaseReportReady={IsReadyForAuditTrail} complete={StableReleaseComplete} report={ReportPath}";
    }
}
...
public static class SigtranStableReleaseReportWriters
{
    ...
    /// <param name="stablePackagePublished">Whether the stable package was published.</param>
    /// <param name="publicationEvidenceRetained">Whether final publication evidence was retained.</param>
    /// <returns>The retained stable release report result.</returns>
    public static SigtranStableReleaseReportWriteResult WriteReport(
        SigtranStablePublishExecutionPlan publishPlan,
        ...
        bool publicationEvidenceRetained)
    {
        ...
        string reportPath = Path.Combine(directory, "stable-release-release-report.md");
    ...
    /// <summary>Renders the stable release release report as Markdown.</summary>
    /// <param name="publishPlan">The stable publish execution plan.</param>
    /// <param name="writtenAtUtc">The UTC report write time.</param>
    /// <param name="stableTagCreated">Whether the stable tag was created and verified.</param>
    /// <param name="stablePackagePublished">Whether the stable package was published.</param>
        ...
        bool publicationEvidenceRetained)
    {
        ...
        bool stableReleaseComplete = publishPlan.IsReady
            && stableTagCreated
            && stablePackagePublished
            && publicationEvidenceRetained;

        StringBuilder builder = new();
        builder.AppendLine("# Stable Production Release Report");
        builder.AppendLine();
        ...
        builder.Append("- Stable release release complete: `").Append(stableReleaseComplete).AppendLine("`");
