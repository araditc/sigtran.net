...
/// <summary>
/// Describes a materialized filesystem-backed commercial evidence command script.
/// </summary>
public sealed class SigtranCommercialEvidenceFileSystemCommandMaterialization
{
    ...
    public SigtranCommercialEvidenceFileSystemCommandMaterialization(
        SigtranCommercialEvidenceFileVerificationCommandPlan commandPlan,
        string scriptPath,
    ...
    public SigtranCommercialEvidenceFileVerificationCommandPlan CommandPlan { get; }
    ...
    {
        return $"commercialEvidenceFileSystemCommandMaterializationReady={IsReady} commands={CommandPlan.Commands.Count} script={ScriptPath}";
    }
}

/// <summary>
/// Provides filesystem-backed commercial evidence command materialization helpers.
/// </summary>
public static class SigtranCommercialEvidenceFileSystemCommandMaterializer
{
    ...
    public static SigtranCommercialEvidenceFileSystemCommandMaterialization WriteScript(
        SigtranCommercialEvidenceFileVerificationCommandPlan commandPlan,
        string scriptPath,
        DateTimeOffset materializedAtUtc)
    {
    ...
    public static string RenderScript(SigtranCommercialEvidenceFileVerificationCommandPlan commandPlan)
    {
        ArgumentNullException.ThrowIfNull(commandPlan);
        ...
        builder.AppendLine();
        builder.Append("# Sigtran.NET commercial evidence filesystem execution artifact root: ")
            .AppendLine(commandPlan.ArtifactRoot);

        foreach (SigtranCommercialEvidenceFileVerificationCommand command in commandPlan.Commands.OrderBy(static item => item.Order))
        {
            builder.AppendLine();
            builder.Append("# ")
