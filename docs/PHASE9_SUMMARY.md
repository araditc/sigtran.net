...
1. Lab scenario catalog for Linux native SCTP, OpenSS7/IPSS7 M3UA ASP-to-SG, and MAP SMS trace comparison.
...
4. OpenSS7/IPSS7 peer profile and M3UA ASP-to-SG template.
...
- OpenSS7/IPSS7 or equivalent external peer run.
