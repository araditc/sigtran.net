...
Status: Phase 31 is in progress. The outbound stream and PPID framing contract, association lifecycle journal, reconnect schedule, send backpressure policy, and cancellation/timeout policy are available.
